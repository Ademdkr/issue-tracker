...
Projekt-Maintainer sind verantwortlich für die Klärung der Standards für akzeptables Verhalten und werden angemessene und faire Korrekturmaßnahmen als Reaktion auf inakzeptables Verhalten ergreifen.

Projekt-Maintainer haben das Recht und die Verantwortung, Kommentare, Commits, Code, Wiki-Bearbeitungen, Issues und andere Beiträge zu entfernen, zu bearbeiten oder abzulehnen, die nicht mit diesem Code of Conduct übereinstimmen, sowie Mitwirkende vorübergehend oder dauerhaft zu sperren, wenn deren Verhalten als unangemessen, bedrohlich, beleidigend oder schädlich eingestuft wird.

## Geltungsbereich

Dieser Code of Conduct gilt sowohl innerhalb von Projekträumen als auch in öffentlichen Räumen, wenn eine Person das Projekt oder seine Community repräsentiert. Beispiele für die Repräsentation eines Projekts oder einer Community sind die Verwendung einer offiziellen Projekt-E-Mail-Adresse, das Posten über ein offizielles Social-Media-Konto oder das Auftreten als ernannter Vertreter bei einer Online- oder Offline-Veranstaltung.

## Durchsetzung

Fälle von beleidigendem, belästigendem oder anderweitig inakzeptablem Verhalten können durch Kontaktaufnahme mit dem Projektteam gemeldet werden. Alle Beschwerden werden überprüft und untersucht und werden zu einer Antwort führen, die den Umständen angemessen ist. Das Projektteam ist verpflichtet, die Vertraulichkeit in Bezug auf den Melder eines Vorfalls zu wahren.

Projekt-Maintainer, die den Code of Conduct nicht nach Treu und Glauben befolgen oder durchsetzen, können vorübergehende oder dauerhafte Konsequenzen erfahren, wie von anderen Mitgliedern der Projektleitung festgelegt.

## Attribution

Dieser Code of Conduct ist eine Adaption des [Contributor Covenant][homepage], Version 2.1, verfügbar unter https://www.contributor-covenant.org/version/2/1/code_of_conduct.html
