...
-- Indizes für Tickets: häufige Abfragen auf Projekt/Status/Priority/Assignee/Reporter
...
-- Junction table between tickets and labels (many-to-many)
...
-- Project members (many-to-many between projects and users) with audit info
...
-- Index auf ticket_id + actor_id + created_at, plus GIN-Index für JSONB detail-Feld
